...
<script src="<?php _e(MILAT_PLUGIN_URL) ?>lib/admin/js/range.js"></script>     
<div class="wrap">
	<table width="100%">
		<tr>
			<td width="80%"><div id="icon-options-general" class="icon32"></div><h2><?php _e("Cài đặt Popup",MILAT_MILAT) ?></h2></td>
			<td width="17%">
			</td>
		</tr>
		<tr>
							...
							<tr valign="top">
								...
								<td>
									<label for="milat_resim">
										...
										<input id="milat_resim_button" type="button" value="Upload Image" />
