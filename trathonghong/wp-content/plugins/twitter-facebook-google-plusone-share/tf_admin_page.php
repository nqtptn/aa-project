...
function twitter_facebook_share_get_options_stored () {
	...
	if (!isset($option['left_space'])) {
		$option['left_space'] = '10px';
	}
	if (!isset($option['bottom_space'])) {
		$option['bottom_space'] = '70px';
	}
...
function twitter_facebook_share_get_options_default ($position='left', $border='flat', $color='#FFF',$left_space='10px',$bottom_space='70px', $float_position='fixed') {
	$option = array();
	$option['auto'] = true;
	$option['active_buttons'] = array('facebook_like'=>true, 'twitter'=>true, 'stumbleupon'=>false, 'Google_plusone'=>true, 'linkedin'=>false,'pinterest'=>false);
	$option['show_in'] = array('posts'=>true, 'pages'=>true, 'home_page'=>false, 'shop'=>true, 'categories'=>true,  'product-category'=>true, 'search'=>true);
	...
	$option['google_count'] = true;
	$option['twitter_count'] = true;
	$option['linkedin_count'] = false;
	$option['pinterest_count'] = false;
	return $option;
}
?>