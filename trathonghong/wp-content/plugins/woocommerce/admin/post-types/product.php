    ...
    <fieldset class="inline-edit-col-left">
		<div id="woocommerce-fields" class="inline-edit-col">
			...
			<div class="price_fields">
				<label>
				    <span class="title"><?php _e('Giá', 'woocommerce'); ?></span>
				    <span class="input-text-wrap">
						<input type="text" name="_regular_price" class="text regular_price" placeholder="<?php _e('Giá', 'woocommerce'); ?>" value="">
					</span>
				</label>
				<br class="clear" />
				<label>
				    <span class="title"><?php _e('Giá khuyến mãi', 'woocommerce'); ?></span>
				    <span class="input-text-wrap">
						<input type="text" name="_sale_price" class="text sale_price" placeholder="<?php _e('Giá khuyến mãi', 'woocommerce'); ?>" value="">
					</span>
				</label>
				<br class="clear" />
			</div>
			...
			<div class="dimension_fields">
				...
				<?php if ( get_option('woocommerce_enable_weight') == "yes" ) : ?>
					<label>
					    <span class="title"><?php _e('Nặng', 'woocommerce'); ?></span>
					    <span class="input-text-wrap">
				...
				<?php if ( get_option('woocommerce_enable_dimensions') == "yes" ) : ?>
					<div class="inline-edit-group dimensions">
						<div>
						    ...
						    <span class="input-text-wrap">
								<input type="text" name="_length" class="text length" placeholder="<?php _e('Dài (L)', 'woocommerce'); ?>" value="">
								<input type="text" name="_width" class="text width" placeholder="<?php _e('Rộng (W)', 'woocommerce'); ?>" value="">
								<input type="text" name="_height" class="text height" placeholder="<?php _e('Cao (H)', 'woocommerce'); ?>" value="">
							</span>
						</div>
					</div>
				<?php endif; ?>
			...
			<label class="alignleft featured">
				...
				<span class="checkbox-title"><?php _e('Chức năng', 'woocommerce'); ?></span>
			</label>
			<br class="clear" />
			<label class="alignleft">
			    <span class="title"><?php _e('Còn hàng?', 'woocommerce'); ?></span>
			    <span class="input-text-wrap">
			    	<select class="stock_status" name="_stock_status">
					<?php
						$options = array(
							'instock' => __('Còn hàng', 'woocommerce'),
							'outofstock' => __('Hết hàng', 'woocommerce')
						);
						foreach ($options as $key => $value) {
							echo '<option value="'.$key.'">'. $value .'</option>';
						}
			...
			<div class="stock_fields">
				...
				<?php if (get_option('woocommerce_manage_stock')=='yes') : ?>
					<label class="alignleft manage_stock">
						...
						<span class="checkbox-title"><?php _e('Quản lý kho?', 'woocommerce'); ?></span>
					</label>
					<br class="clear" />
					<label class="stock_qty_field">
					    <span class="title"><?php _e('Số lượng còn', 'woocommerce'); ?></span>
					    <span class="input-text-wrap">
...
function woocommerce_admin_product_bulk_edit( $column_name, $post_type ) {
    ...
    <fieldset class="inline-edit-col-right">
		<div id="woocommerce-fields-bulk" class="inline-edit-col">
			...
			<div class="inline-edit-group">
				<label class="alignleft">
				    ...
				    <span class="input-text-wrap">
						...
						<?php
							$options = array(
								'' 	=> __('— Không thay đổi —', 'woocommerce'),
								'1' => __('Thay đổi:', 'woocommerce')
							);
							foreach ($options as $key => $value) {
								echo '<option value="'.$key.'">'. $value .'</option>';
							}
			...
			<label>
			    <span class="title"><?php _e('Chức năng', 'woocommerce'); ?></span>
			    <span class="input-text-wrap">
			...
			<?php if (get_option('woocommerce_manage_stock')=='yes') : ?>
				<label>
				    <span class="title"><?php _e('Quản lý kho?', 'woocommerce'); ?></span>
				    <span class="input-text-wrap">
				...
				<div class="inline-edit-group dimensions">
					...
					<label class="alignright">
						<input type="text" name="_stock" class="text stock" placeholder="<?php _e('Số lượng còn', 'woocommerce'); ?>" value="">
					</label>
				</div>
			<?php endif; ?>
