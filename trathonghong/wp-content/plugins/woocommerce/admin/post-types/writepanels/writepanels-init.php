...
function woocommerce_meta_boxes() {
	...
	// Products
	add_meta_box( 'woocommerce-product-data', __('Thông tin sản phẩm', 'woocommerce'), 'woocommerce_product_data_box', 'product', 'normal', 'high' );
	...
	if ( function_exists('wp_editor') ) {
		...
		add_meta_box( 'postexcerpt', __('Mô tả ngắn về sản phẩm', 'woocommerce'), 'woocommerce_product_short_description_meta_box', 'product', 'normal' );
	}
...
function woocommerce_enter_title_here( $text, $post ) {
	...
	if ( $post->post_type == 'product' ) return __('Tên sản phẩm', 'woocommerce');
	return $text;
}
