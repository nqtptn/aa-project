...
function woocommerce_add_attribute() {
	...
	<div class="wrap woocommerce">
		<div class="icon32 icon32-attributes" id="icon-woocommerce"><br/></div>
	    <h2><?php _e('Thuộc tính', 'woocommerce') ?></h2>
	    <br class="clear" />
	    <div id="col-container">
	    	...
	    	<div id="col-left">
	    		<div class="col-wrap">
	    			<div class="form-wrap">
	    				<h3><?php _e('Thêm thuộc tính', 'woocommerce') ?></h3>
	    				...
	    				<form action="admin.php?page=woocommerce_attributes" method="post">
							...
							<p class="submit"><input type="submit" name="add_new_attribute" id="submit" class="button" value="<?php _e('Thêm thuộc tính', 'woocommerce'); ?>"></p>
