...
function woocommerce_preview_emails() {
	if ( isset( $_GET['preview_woocommerce_mail'] ) ) {
		...
		$email_heading = __('Đặt hàng thành công', 'woocommerce');

		$message  = wpautop( __("Cảm ơn quý khách đã đặt mua sản phẩm của chúng tôi, thông tin đơn hàng của quý khách là:", 'woocommerce') );

		$message .= '<h2>' . __('Đơn hàng:', 'woocommerce') . ' ' . '#1000</h2>';
