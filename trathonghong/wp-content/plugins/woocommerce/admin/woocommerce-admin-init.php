...
function woocommerce_admin_menu() {
    ...
    $main_page = add_menu_page(__('Đơn hàng', 'woocommerce'), __('Đơn hàng', 'woocommerce'), 'manage_woocommerce', 'woocommerce' , 'woocommerce_settings_page', null, '55.5' );

    $reports_page = add_submenu_page('woocommerce', __('Báo cáo', 'woocommerce'),  __('Báo cáo', 'woocommerce') , 'view_woocommerce_reports', 'woocommerce_reports', 'woocommerce_reports_page');

    add_submenu_page('edit.php?post_type=product', __('Attributes', 'woocommerce'), __('Thuộc tính', 'woocommerce'), 'manage_woocommerce_products', 'woocommerce_attributes', 'woocommerce_attributes_page');
...
function woocommerce_admin_menu_after() {
	add_submenu_page( 'woocommerce', __('WooCommerce Settings', 'woocommerce'),  __('Cài đặt', 'woocommerce') , 'manage_woocommerce', 'woocommerce_settings', 'woocommerce_settings_page');
	add_submenu_page( 'woocommerce', __('WooCommerce Status', 'woocommerce'),  __('Trạng thái hệ thống', 'woocommerce') , 'manage_woocommerce', 'woocommerce_status', 'woocommerce_status_page');
}
...
function woocommerce_admin_comment_types_dropdown( $types ) {
	$types['order_note'] = __( 'Ghi chú', 'woocommerce' );
	return $types;
}
