...
function woocommerce_create_pages() {
	...
	// Shop page
    woocommerce_create_page( esc_sql( _x('shop', 'page_slug', 'woocommerce') ), 'woocommerce_shop_page_id', __('Mua hàng online', 'woocommerce'), '' );

    // Cart page
    woocommerce_create_page( esc_sql( _x('cart', 'page_slug', 'woocommerce') ), 'woocommerce_cart_page_id', __('Giỏ hàng', 'woocommerce'), '[woocommerce_cart]' );

	// Checkout page
    woocommerce_create_page( esc_sql( _x('checkout', 'page_slug', 'woocommerce') ), 'woocommerce_checkout_page_id', __('Đặt hàng', 'woocommerce'), '[woocommerce_checkout]' );

    // Order tracking page
    woocommerce_create_page( esc_sql( _x('order-tracking', 'page_slug', 'woocommerce') ), 'woocommerce_order_tracking_page_id', __('Huỷ đơn hàng', 'woocommerce'), '[woocommerce_order_tracking]' );

	// My Account page
    woocommerce_create_page( esc_sql( _x('my-account', 'page_slug', 'woocommerce') ), 'woocommerce_myaccount_page_id', __('Xem tài khoản', 'woocommerce'), '[woocommerce_my_account]' );

	// Edit address page
    woocommerce_create_page( esc_sql( _x('edit-address', 'page_slug', 'woocommerce') ), 'woocommerce_edit_address_page_id', __('Cập nhật địa chỉ', 'woocommerce'), '[woocommerce_edit_address]', woocommerce_get_page_id('myaccount') );

    // View order page
    woocommerce_create_page( esc_sql( _x('view-order', 'page_slug', 'woocommerce') ), 'woocommerce_view_order_page_id', __('Xem đơn hàng', 'woocommerce'), '[woocommerce_view_order]', woocommerce_get_page_id('myaccount') );

    // Change password page
    woocommerce_create_page( esc_sql( _x('change-password', 'page_slug', 'woocommerce') ), 'woocommerce_change_password_page_id', __('Thay đổi Password', 'woocommerce'), '[woocommerce_change_password]', woocommerce_get_page_id('myaccount') );

	// Pay page
    woocommerce_create_page( esc_sql( _x('pay', 'page_slug', 'woocommerce') ), 'woocommerce_pay_page_id', __('Đặt hàng &rarr; Thanh toán', 'woocommerce'), '[woocommerce_pay]', woocommerce_get_page_id('checkout') );

    // Thanks page
    woocommerce_create_page( esc_sql( _x('order-received', 'page_slug', 'woocommerce') ), 'woocommerce_thanks_page_id', __('Chấp nhận đơn hàng', 'woocommerce'), '[woocommerce_thankyou]', woocommerce_get_page_id('checkout') );
