	...
	function get_address_fields( $country, $type = 'billing_' ) {
		...
		$fields = array(
			'first_name' => array(
				...
				'placeholder' 	=> _x('Họ', 'placeholder', 'woocommerce'),
				'required' 		=> true,
			...
			'company' 	=> array(
				...
				'placeholder' 	=> _x('Công ty (Không bắt buộc)', 'placeholder', 'woocommerce'),
				'clear'			=> true
				),
			'address_1' 	=> array(
				'label' 		=> __('Địa chỉ', 'woocommerce'),
				'placeholder' 	=> _x('Số nhà, Tên đường', 'placeholder', 'woocommerce'),
				'required' 		=> true,
				'class' 		=> array('form-row-first'),
				),
			'address_2' => array(
				'label' 		=> __('Phường, Quận', 'woocommerce'),
				'placeholder' 	=> _x('Phường, Quận', 'placeholder', 'woocommerce'),
				'class' 		=> array('form-row-last'),
				'label_class' 	=> array('hidden'),
				'clear'			=> true
				),
			'city' 		=> array(
				'label' 		=> __('Tỉnh / TP', 'woocommerce'),
				'placeholder' 	=> _x('Tỉnh / TP', 'placeholder', 'woocommerce'),
				'required' 		=> true,
				'class' 		=> array('form-row-first'),
				'clear'			=> true
				)
		...
		if ( $type == 'billing_' ) {
			...
			$address_fields['billing_phone'] = array(
				'label' 		=> __('Điện thoại', 'woocommerce'),
