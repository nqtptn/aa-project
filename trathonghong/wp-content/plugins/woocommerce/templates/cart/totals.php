		...
		<table cellspacing="0" cellpadding="0">
			<tbody>
				...
				<tr class="cart-subtotal">
					<th><strong><?php _e('Tổng', 'woocommerce'); ?></strong></th>
				...
				<tr class="discount">
					<th><?php _e('Giảm giá', 'woocommerce'); ?> <a href="<?php echo add_query_arg('remove_discounts', '1', $woocommerce->cart->get_cart_url()) ?>"><?php _e('[Remove]', 'woocommerce'); ?></a></th>
				...
				<tr class="shipping">
					<th><?php _e('Giao hàng', 'woocommerce'); ?></th>
					<td>
					<?php
						...
						// No shipping methods are available
							...
							if ( ! $woocommerce->customer->get_shipping_country() || ! $woocommerce->customer->get_shipping_state() || ! $woocommerce->customer->get_shipping_postcode() ) {
								echo '<p>'.__('Vui lòng nhập thông tin giao hàng.', 'woocommerce').'</p>';
							} else {
				...
				<?php
					...
					elseif ( get_option('woocommerce_display_cart_taxes_if_zero') == 'yes' ) :
						...
						<tr class="tax">
							<th><?php _e('Thuế', 'woocommerce'); ?></th>
							<td><?php _ex( 'N/A', 'Liên quan đến thuế', 'woocommerce' ); ?></td>
						</tr>
						<?php
