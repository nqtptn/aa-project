...
<div id="order_review">
	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-total"><?php _e('Thành tiền', 'woocommerce'); ?></th>
			</tr>
		</thead>
		<tfoot>

			<tr class="cart-subtotal">
				<th colspan="2"><strong><?php _e('Tổng', 'woocommerce'); ?></strong></th>
			...
			<tr class="discount">
				<th colspan="2"><?php _e('Giảm giá', 'woocommerce'); ?></th>
			...
			<tr class="shipping">
				<th colspan="2"><?php _e('Giao hàng', 'woocommerce'); ?></th>
				<td>
				<?php
					...
					// No shipping methods are available
						...
						if ( ! $woocommerce->customer->get_shipping_country() || ! $woocommerce->customer->get_shipping_state() || ! $woocommerce->customer->get_shipping_postcode() ) {
							echo '<p>'.__('Giao hàng theo địa chỉ bên trên.', 'woocommerce').'</p>';
						} else {
							echo '<p>'.__('Xin lỗi, có vẽ như không xác định được phương thức giao hàng, vui lòng liên hệ với chúng tôi để được hỗ trợ tốt nhất.', 'woocommerce').'</p>';
						}
			...
			<tr class="total">
				<th colspan="2"><strong><?php _e('Tổng đơn hàng', 'woocommerce'); ?></strong></th>
	...
	<div id="payment">
		...
		<div class="form-row place-order">
			...
			<input type="submit" class="button alt" name="woocommerce_checkout_place_order" id="place_order" value="<?php echo apply_filters('woocommerce_order_button_text', __('Xác nhận đặt hàng', 'woocommerce')); ?>" />
