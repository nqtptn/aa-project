...
<form action="<?php echo esc_url( $product->add_to_cart_url() ); ?>" class="cart" method="post" enctype='multipart/form-data'>
				...
				<tr>
					<td>
						...
						<?php elseif ( ! $quantites_required ) : ?>
							...
							<button type="submit" name="quantity[<?php echo $child_product['product']->id; ?>]" value="1" class="single_add_to_cart_button button alt"><?php _e('+ Giỏ hàng', 'woocommerce'); ?></button>
	...
	<?php if ( $quantites_required ) : ?>
		...
		<button type="submit" class="single_add_to_cart_button button alt"><?php echo apply_filters('single_add_to_cart_text', __('+ Giỏ hàng', 'woocommerce'), $product->product_type); ?></button>
