<?php
/**
 * Plugin Name: Shopping online
 * Plugin URI: http://trathonghong.com
 * Description: An e-commerce toolkit that helps you sell anything. Beautifully.
 * Version: 1.6.5.2
 * Author: WooThemes
 * Author URI: http://trathonghong.com
...
class Woocommerce {
	 ...
	 */
	function generator() {
		echo "\n\n" . '<!-- WooCommerce Version -->' . "\n" . '<meta name="generator" content="Cài đặt sản phẩm ' . $this->version . '" />' . "\n\n";
	}
	...
	function init_user_roles() {
		...
		if ( is_object($wp_roles) ) {
			...
			// Customer role
			add_role( 'customer', __('Khách hàng', 'woocommerce'), array(
			    'read' 						=> true,
			    'edit_posts' 				=> false,
			    'delete_posts' 				=> false
			) );
			...
			// Shop manager role
			add_role( 'shop_manager', __('Quản lý shop', 'woocommerce'), array(
			    'read' 						=> true,
	...
	function init_taxonomy() {
		...
		register_taxonomy( 'product_cat',
	        ...
	        array(
	            'hierarchical' 			=> true,
	            'update_count_callback' => '_update_post_term_count',
	            'label' 				=> __( 'Danh mục sản phẩm', 'woocommerce'),
	            'labels' => array(
	                    'name' 				=> __( 'Danh mục sản phẩm', 'woocommerce'),
	                    'singular_name' 	=> __( 'Danh mục sản phẩm', 'woocommerce'),
						'menu_name'			=> _x( 'Danh mục sản phẩm', 'Admin menu name', 'woocommerce' ),
	                    'search_items' 		=> __( 'Tìm kiếm', 'woocommerce'),
	                    'all_items' 		=> __( 'Tất cả danh mục sản phẩm', 'woocommerce'),
	                    'parent_item' 		=> __( 'Cấp cha danh mục sản phẩm', 'woocommerce'),
	                    'parent_item_colon' => __( 'Cấp cha danh mục sản phẩm:', 'woocommerce'),
	                    'edit_item' 		=> __( 'Sửa', 'woocommerce'),
	                    'update_item' 		=> __( 'Cập nhật', 'woocommerce'),
	                    'add_new_item' 		=> __( 'Thêm mới', 'woocommerce'),
	                    'new_item_name' 	=> __( 'Danh mục sản phẩm mới', 'woocommerce')
	            	),
	            'show_ui' 				=> true,
	            'query_var' 			=> true,
	            'capabilities'			=> array(
		...
		register_taxonomy( 'product_shipping_class',
	        ...
	        array(
	            'hierarchical' 			=> true,
	            'update_count_callback' => '_update_post_term_count',
	            'label' 				=> __( 'Danh mục vận chuyển', 'woocommerce'),
	            'labels' => array(
	                    'name' 				=> __( 'Danh mục vận chuyển', 'woocommerce'),
	                    'singular_name' 	=> __( 'Danh mục vận chuyển', 'woocommerce'),
						'menu_name'			=> _x( 'Danh mục vận chuyển', 'Admin menu name', 'woocommerce' ),
	                    'search_items' 		=> __( 'Tìm danh mục vận chuyển', 'woocommerce'),
	                    'all_items' 		=> __( 'Tất cả danh mục vận chuyển', 'woocommerce'),
	                    'parent_item' 		=> __( 'Cấp cha danh mục vận chuyển', 'woocommerce'),
	                    'parent_item_colon' => __( 'Cấp cha danh mục vận chuyển:', 'woocommerce'),
	                    'edit_item' 		=> __( 'Sửa', 'woocommerce'),
	                    'update_item' 		=> __( 'Cập nhật', 'woocommerce'),
	                    'add_new_item' 		=> __( 'Thêm mới', 'woocommerce'),
	                    'new_item_name' 	=> __( 'Danh mục vận chuyển mới', 'woocommerce')
	            	),
	            'show_ui' 				=> true,
	            'show_in_nav_menus' 	=> false,
	            'query_var' 			=> $admin_only_query_var,
	    ...
	    register_taxonomy( 'shop_order_status',
	        ...
	        array(
	            ...
	            'update_count_callback' => '_update_post_term_count',
	            'labels' => array(
	                    'name' 				=> __( 'Trạng thái đơn hàng', 'woocommerce'),
	                    'singular_name' 	=> __( 'Trạng thái đơn hàng', 'woocommerce'),
	                    'search_items' 		=> __( 'Tìm trạng thái đơn hàng', 'woocommerce'),
	                    'all_items' 		=> __( 'Tất cả trạng thái đơn hàng', 'woocommerce'),
	                    'parent_item' 		=> __( 'Cấp cha', 'woocommerce'),
	                    'parent_item_colon' => __( 'Cấp cha:', 'woocommerce'),
	                    'edit_item' 		=> __( 'Sửa', 'woocommerce'),
	                    'update_item' 		=> __( 'Cập nhật', 'woocommerce'),
	                    'add_new_item' 		=> __( 'Thêm mới', 'woocommerce'),
	                    'new_item_name' 	=> __( 'Thêm mới', 'woocommerce')
	           	 ),
	            'show_ui' 				=> false,
	            'show_in_nav_menus' 	=> false,
	            'query_var' 			=> $admin_only_query_var,
		...
		register_post_type( "product",
			array(
				'labels' => array(
						...
						'singular_name' 		=> __( 'Danh sách', 'woocommerce' ),
						'menu_name'				=> _x( 'Sản phẩm', 'Admin menu name', 'woocommerce' ),
						'add_new' 				=> __( 'Thêm sản phẩm', 'woocommerce' ),
						'add_new_item' 			=> __( 'Thêm sản phẩm', 'woocommerce' ),
						'edit' 					=> __( 'Sửa sản phẩm', 'woocommerce' ),
						'edit_item' 			=> __( 'Sửa sản phẩm', 'woocommerce' ),
						'new_item' 				=> __( 'Sản phẩm mới', 'woocommerce' ),
						'view' 					=> __( 'Xem sản phẩm', 'woocommerce' ),
						'view_item' 			=> __( 'Xem sản phẩm', 'woocommerce' ),
						'search_items' 			=> __( 'Tìm sản phẩm', 'woocommerce' ),
						'not_found' 			=> __( 'Không tìm thấy sản phẩm', 'woocommerce' ),
						'not_found_in_trash' 	=> __( 'Không tìm thấy sản phẩm', 'woocommerce' ),
						'parent' 				=> __( 'Parent Product', 'woocommerce' )
					),
				'description' 			=> __( 'Bạn có thể thêm sản phẩm mới tại đây.', 'woocommerce' ),
				'public' 				=> true,
				'show_ui' 				=> true,
		...
		register_post_type( "product_variation",
			array(
				'labels' => array(
						'name' 					=> __( 'Tham số sản phẩm', 'woocommerce' ),
						'singular_name' 		=> __( 'Tham số sản phẩm', 'woocommerce' ),
						'add_new' 				=> __( 'Thêm', 'woocommerce' ),
						'add_new_item' 			=> __( 'Thêm mới tham số sản phẩm', 'woocommerce' ),
						'edit' 					=> __( 'Sửa', 'woocommerce' ),
						'edit_item' 			=> __( 'Sửa tham số sản phẩm', 'woocommerce' ),
						'new_item' 				=> __( 'Tham số sản phẩm mới', 'woocommerce' ),
						'view' 					=> __( 'Xem', 'woocommerce' ),
						'view_item' 			=> __( 'Xem tham số sản phẩm', 'woocommerce' ),
						'search_items' 			=> __( 'Tìm tham số sản phẩm', 'woocommerce' ),
						'not_found' 			=> __( 'Không tìm thấy tham số sản phẩm', 'woocommerce' ),
						'not_found_in_trash' 	=> __( 'Không tìm thấy tham số sản phẩm', 'woocommerce' ),
						'parent' 				=> __( 'Cấp cha', 'woocommerce' )
					),
				'public' 				=> true,
				'show_ui' 				=> false,
				'capability_type' 		=> 'post',
		...
		$menu_name = _x('Đặt hàng', 'Admin menu name', 'woocommerce');
	    ...
	    register_post_type( "shop_order",
			array(
				'labels' => array(
						'name' 					=> __( 'Đơn hàng', 'woocommerce' ),
						'singular_name' 		=> __( 'Đơn hàng', 'woocommerce' ),
						'add_new' 				=> __( 'Thêm đơn hàng', 'woocommerce' ),
						'add_new_item' 			=> __( 'Thêm đơn hàng', 'woocommerce' ),
						'edit' 					=> __( 'Sửa', 'woocommerce' ),
						'edit_item' 			=> __( 'Sửa đơn hàng', 'woocommerce' ),
						'new_item' 				=> __( 'Đơn hàng mới', 'woocommerce' ),
						'view' 					=> __( 'Xem đơn hàng', 'woocommerce' ),
						'view_item' 			=> __( 'Xem đơn hàng', 'woocommerce' ),
						'search_items' 			=> __( 'Tìm đơn hàng', 'woocommerce' ),
						'not_found' 			=> __( 'Không tìm thấy đơn hàng', 'woocommerce' ),
						'not_found_in_trash' 	=> __( 'Không tìm thấy đơn hàng', 'woocommerce' ),
						'parent' 				=> __( 'Cấp cha', 'woocommerce' ),
						'menu_name'				=> $menu_name
					),
				'description' 			=> __( 'Bạn có thể đặt hàng tại đây.', 'woocommerce' ),
				'public' 				=> true,
				'show_ui' 				=> true,
				'capability_type' 		=> 'post',
				'capabilities' => array(
	    ...
	    register_post_type( "shop_coupon",
			array(
				'labels' => array(
						'name' 					=> __( 'Phiếu giảm giá', 'woocommerce' ),
						'singular_name' 		=> __( 'Phiếu giảm giá', 'woocommerce' ),
						'menu_name'				=> _x( 'Phiếu giảm giá', 'Admin menu name', 'woocommerce' ),
						'add_new' 				=> __( 'Thêm phiếu giảm giá', 'woocommerce' ),
						'add_new_item' 			=> __( 'Thêm phiếu giảm giá', 'woocommerce' ),
						'edit' 					=> __( 'Sửa', 'woocommerce' ),
						'edit_item' 			=> __( 'Sửa phiếu giảm giá', 'woocommerce' ),
						'new_item' 				=> __( 'Phiếu giảm giá mới', 'woocommerce' ),
						'view' 					=> __( 'Xem phiếu giảm giá', 'woocommerce' ),
						'view_item' 			=> __( 'Xem phiếu giảm giá', 'woocommerce' ),
						'search_items' 			=> __( 'Tìm phiếu giảm giá', 'woocommerce' ),
						'not_found' 			=> __( 'Không tìm thấy phiếu giảm giá', 'woocommerce' ),
						'not_found_in_trash' 	=> __( 'Không tìm thấy phiếu giảm giá', 'woocommerce' ),
						'parent' 				=> __( 'Cấp cha', 'woocommerce' )
					),
				'description' 			=> __( 'Bạn có thể thêm phiếu giảm giá tại đây.', 'woocommerce' ),
				'public' 				=> true,
				'show_ui' 				=> true,
				'capability_type' 		=> 'post',
				'capabilities' => array(
