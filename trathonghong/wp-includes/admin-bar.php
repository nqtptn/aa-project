...
function wp_admin_bar_comments_menu( $wp_admin_bar ) {
	...
	$awaiting_mod = wp_count_checkout();
	$awaiting_mod = $awaiting_mod->total_orders;
	$awaiting_title = esc_attr( sprintf( _n( '%s đơn hàng đang chờ xử lý', '%s đơn hàng đang chờ xử lý', $awaiting_mod ), number_format_i18n( $awaiting_mod ) ) );
