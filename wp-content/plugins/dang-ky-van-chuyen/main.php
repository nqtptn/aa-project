<?php
/*
Plugin Name: Đăng ký vận chuyển
Plugin URI: http://www.aa-express.net
Description: Đăng ký vận chuyển
Version: 1.0
Author: NhaLT
Author URI: http://www.aa-express.net
...
class Magic_Contact {
  ...
  function mc_admin_actions(){
    add_options_page("Magic Contact", "Đăng ký vận chuyển", 'manage_options',"magic-contact.php", array(&$this,"magic_contact_menu"));
  }
